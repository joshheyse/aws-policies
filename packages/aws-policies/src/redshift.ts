...
export enum redshift {
 All = 'redshift:*',
 Authorize = 'redshift:Authorize*',
 Batch = 'redshift:Batch*',
 Cancel = 'redshift:Cancel*',
 Create = 'redshift:Create*',
 Delete = 'redshift:Delete*',
 Describe = 'redshift:Describe*',
 Disable = 'redshift:Disable*',
 Enable = 'redshift:Enable*',
 Get = 'redshift:Get*',
 List = 'redshift:List*',
 Modify = 'redshift:Modify*',
 Restore = 'redshift:Restore*',
 Revoke = 'redshift:Revoke*',
 View = 'redshift:View*',
